...
public class EventProgressOverview {
    ...
    public EventProgressOverview(Long eventId, String eventName, long scannedCount, long totalLocations, long remaining, List<ScannedLocationCard> scannedLocations) {
